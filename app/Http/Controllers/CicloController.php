...
class CicloController extends Controller
{
     ...
     public function index1()
    {
        if(accesoUser([1,2])){
            ...
            return view('ciclos.index',compact('modulo','imagenPerfil','tipouser'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
         ...
         if ($validator1->fails())
        {
            ...
            $msj='Nuevo Año Escolar Académico configurado con éxito';
    ...
    public function update(Request $request, $id)
    {
        ...
        elseif(!validaFecha($fecIni)){
            ...
            $msj='El Año Escolar Académico ha sido modificado con éxito';
        }
     ...
     public function activar($id,$estado)
    {
        ...
        if(strval($estado)=="0"){
            $msj='El Año Escolar seleccionado fue Desactivado exitosamente';
        }elseif(strval($estado)=="1"){
            $msj='El Año Escolar seleccionado fue Activado exitosamente';
        }
    ...
    public function destroy($id)
    {
       ...
       /* $consulta=DB::table('ciclos')
        ...
        if ($consulta>0) {
            $result='0';
            $msj='El Año Escolar Seleccionado no puede ser eliminado, debido a que cuenta con registros de alumnos matriculados en él';
        }else{
        ...
        $borrarCiclo = Ciclo::destroy($id);


        $msj='El Año Escolar Académico ha sido eliminado exitosamente';
