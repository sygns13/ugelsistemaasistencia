...
class AsistenciaAlumnoController extends Controller
{
    ...
    public function index1()
    {
        ...
        $secActual=date("s");
            ...
            return view('asistenciaalumnos.index',compact('modulo','imagenPerfil','tipouser','fecha','hora','turnoActivo','diaActual','mesActual','yearActual','horaActual','minActual','secActual'));
