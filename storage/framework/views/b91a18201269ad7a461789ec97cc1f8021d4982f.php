...
<div class="col-md-12">
 ...
 <div class="col-md-12" style="padding-top: 15px;">
                ...
                <div class="form-group">
                  <label for="cbuHoraEfectiva" class="col-sm-2 control-label">Se imprime en el Reporte:*</label>

                  <div class="col-sm-4">
                  <select class="form-control" id="cbuHoraEfectiva" name="cbuHoraEfectiva" v-model="newHora">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                  <label for="txtjornada" class="col-sm-1 control-label">Jornada Laboral:*</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txtjornada" name="txtjornada" placeholder="Jornada Laboral" maxlength="200" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="newJornada">
                  </div>

                  <label for="txtgrado" class="col-sm-1 control-label">Grado:*</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txtgrado" name="txtgrado" placeholder="Grado" maxlength="100" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="newGrado">
                  </div>
                </div>
              </div>
               ...
               <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                  <label for="txtseccion" class="col-sm-1 control-label">Sección:*</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txtseccion" name="txtseccion" placeholder="Sección" maxlength="100" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="newSeccion">
                  </div>

                  <label for="txtespecialidad" class="col-sm-1 control-label">Especialidad:*</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txtespecialidad" name="txtespecialidad" placeholder="Especialidad" maxlength="200" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="newEspecialidad">
                  </div>
                </div>
              </div>
    ...
    </form><?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/personals/formulario.blade.php ENDPATH**/ ?>