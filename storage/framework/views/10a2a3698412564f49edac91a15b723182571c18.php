      ...
      <table style="border: 0px solid gray; width: 100%;">
        <tr>
          <td style="font-size: 12px;" v-if="cbuIE==0">
            Reporte General de la UGEL Carhuaz e Instituciones Educativas
          </td>
             ...
             <div class="box-body table-responsive">
              <table class="table table-hover table-bordered" >
                <tbody><tr>
                  ...
                  <th style="font-size: 12px;padding: 3px; width: 9%;" class="columnanoprint">Archivo Adjunto</th>
                </tr>
                <tr v-for="reporte, key in report">
                  ...
                  <td style="font-size: 10px; padding: 3px;" class="columnanoprint">
...
<?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/reporteJustificacion/principal.blade.php ENDPATH**/ ?>