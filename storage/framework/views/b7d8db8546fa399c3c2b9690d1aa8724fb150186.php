                ...
                <tr v-for="licencia, key in licencias">
                  ...
                  <td style="font-size: 12px; padding: 5px;">
                    <span class="label label-default" v-if="licencia.rutafile==''">None</span>
                     ...
                     <template v-if="licencia.rutafile.length>0 ">

                    <a  v-if="licencia.namefile.length>0" v-bind:href="'<?php echo e(asset('/img/informacion/files/')); ?>/'+licencia.rutafile" v-bind:download="licencia.namefile">{{ licencia.namefile }}</a>
...
</form><?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/personals/contenidoLicencia.blade.php ENDPATH**/ ?>