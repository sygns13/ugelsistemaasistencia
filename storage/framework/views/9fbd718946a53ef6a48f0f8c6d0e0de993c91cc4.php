<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Gestión del Los Años Escolares</h3>
        ...
        <div class="box box-success" v-if="divNuevoCiclo">
            <div class="box-header with-border" >
              <h3 class="box-title" id="tituloAgregar">Nuevo Año Escolar</h3>
            </div>
            ...
            <form v-on:submit.prevent="createCiclo">
             <div class="box-body">
             	...
             	<div class="form-group">
                  <label for="txtciclo" class="col-sm-2 control-label">Nombre del Año:*</label>
                ...
                <div class="form-group">
                  <label for="txtfecIni" class="col-sm-2 control-label">Fecha de Inicio del Año Escolar:*</label>

                  <div class="col-sm-3">
                    <input type="date" class="form-control" id="txtfecIni" name="txtfecIni" placeholder="dd/mm/aaaa" maxlength="10"  v-model="newFecIni">
                  </div>

                  <label for="txtFecFin" class="col-sm-2 control-label">Fecha Final del Año Escolar:*</label>
        ...
        <div class="sk-circle12 sk-child"></div>
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Listado de Años Escolares</h3>
            ...
            <div class="box-body table-responsive">
              <table class="table table-hover table-bordered" >
                <tbody><tr>
                  ...
                  <th style="padding: 5px; width: 25%;">Año</th>
                ...
                <tr v-for="ciclo, key in ciclos">
                  ...
                  <td style="font-size: 12px; padding: 5px;">
                  	...
                  	<a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editciclo(ciclo)" data-placement="top" data-toggle="tooltip" title="Editar Año Escolar"><i class="fa fa-edit"></i></a>
                  	<a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarciclo(ciclo)" data-placement="top" data-toggle="tooltip" title="Borrar Año Escolar"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
  ...
  <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="desEditarTitulo" style="font-weight: bold;text-decoration: underline;">EDITAR AÑO ESCOLAR</h4>
      ...
      <div class="box" id="o" style="border:0px; box-shadow:none;" >
            <div class="box-header with-border">
              <h3 class="box-title" id="boxTitulo">AÑO:</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <div class="col-md-12" >
               <div class="form-group">
                  <label for="txtcicloE" class="col-sm-2 control-label">Nombre del Año:*</label>
...
<?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/ciclos/ciclo.blade.php ENDPATH**/ ?>