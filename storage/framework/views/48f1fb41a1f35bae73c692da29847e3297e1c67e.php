...
<img src="<?php echo e(asset('/img/logo.png')); ?>" class="img-responsive" id="logo-login" style="padding-top: 100px;" >

</center>
        <div class="login-box" style="margin-top: 30px;">

            <div class="login-logo" style="    width: 400px;">
                <a href="<?php echo e(url('/home')); ?>" style="color: white;"><b>Registro de Asistencia SEMÁFORO ESCUELA</b> UGEL CARHUAZ</a>
            </div><!-- /.login-logo -->
...
<?php echo $__env->make('adminlte::layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/vendor/adminlte/auth/login.blade.php ENDPATH**/ ?>