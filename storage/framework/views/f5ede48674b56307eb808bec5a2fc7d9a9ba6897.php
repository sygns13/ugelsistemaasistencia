<script type="text/javascript">
    ...
    data:{
        ...
        ciclos: [],
        errors:[],
        fillCiclo:{'id':'', 'ciclo':'', 'fechainicio':'','fechafin':'','estado':''},
        pagination: {
        'total': 0,
                'current_page': 0,
                'per_page': 0,
    ...
    methods: {
        ...
        borrarciclo:function (Ciclo) {
              swal({
                  title: '¿Estás seguro?',
                  text: "¿Desea eliminar el Año Seleccionado? -- Nota: Si elimina la configuración de este año, no se visualizaran fechas en el reporte",
                  type: 'info',
        ...
        updateCiclo:function (id) {
            ...
            axios.put(url, this.fillCiclo).then(response=>{
                ...
                if(response.data.result=='1'){   
                this.getCiclos(this.thispage);
                this.fillCiclo={'id':'', 'ciclo':'', 'fechainicio':'','fechafin':'','estado':''},
                this.errors=[];
...
</script><?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/ciclos/vue.blade.php ENDPATH**/ ?>