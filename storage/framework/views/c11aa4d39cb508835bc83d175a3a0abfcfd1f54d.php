<div class="box box-primary">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Leyenda de Turnos Habilitados Para Registrar Datos</h3>
</div>
          ...
          <div class="box-body table-responsive">
              <table class="table table-hover table-bordered" >
               ...
               <tr v-for="personal, key in personals" >
                  ...
                  <template v-if="personal.activoDia==0">
                   ...
                   <template v-if="personal.activoDia==1"> 
                    ...
                    <td style="font-size: 12px; padding: 5px;">{{ personal.turno }}</td>
                      ...
                      <template v-if="String(personal.idAsist)=='null' || String(personal.asist)=='0'">

                        <td style="font-size: 12px; padding: 5px;">{{personal.asistencia }}</td>
                        <td style="font-size: 12px; padding: 5px;">No aplica</td>
                        <td style="font-size: 12px; padding: 5px;">No aplica</td>
                      ...
                      <template v-if="String(personal.asist)=='1'">

                         <td style="font-size: 12px; padding: 5px;">{{personal.asistencia }}</td>
                        <td style="font-size: 12px; padding: 5px;">{{personal.horastarde}} Horas, {{ personal.minutostarde }} Min</td>
                        <td style="font-size: 12px; padding: 5px;">{{personal.hrasper}} Horas, {{ personal.minper }} Min</td>
                  ...
                  <template v-if="String(personal.asistencia)!='null'&& personal.asistencia!=false && personal.asistencia!='' && personal.asistencia!='I' && personal.asistencia!=0 && personal.asistencia!='J' && personal.asistencia!='F' && personal.asistencia!='L' && personal.asistencia!='P' && personal.asistencia!='H'">
...
<?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/asistenciapersonal/principal.blade.php ENDPATH**/ ?>