<div class="box box-primary" v-if="mostrarPalenIni">
        ...
        <?php echo $__env->make('usuarios.formulario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
        ...
        <?php echo $__env->make('usuarios.editar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
            ...
            <div class="box-body table-responsive">
              <table class="table table-hover table-bordered" >
                <tbody><tr>
                  ...
                  <th style="padding: 5px; width: 17%;">Apellidos y Nombres</th>
                  <th style="padding: 5px; width: 6%;">DNI</th>
                  <th style="padding: 5px; width: 13%;">Usuario</th>
                  <th style="padding: 5px; width: 17%;">Email</th>
                  <th style="padding: 5px; width: 7%;">Estado</th>
                  <th style="padding: 5px; width: 9%;">Rectificar Asistencias</th>
                  <th style="padding: 5px; width: 17%;">Gestión</th>
                </tr>
                <tr v-for="usuario, key in usuarios">
                  ...
                  <td style="font-size: 12px; padding: 5px;">
                    <span class="label label-success" v-if="usuario.llenarold=='1'">Autorizado</span>
                    <span class="label label-warning" v-if="usuario.llenarold=='0'">No Autorizado</span>
                  </td>

                  <td style="font-size: 12px; padding: 5px;">


                    <a href="#" v-if="usuario.llenarold=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajaUsuarioOld(usuario)" data-placement="top" data-toggle="tooltip" title="Quitar Autorización Usuario Completar Asistencia Pasadas"><i class="fa fa-calendar-times-o"></i></a>

                    <a href="#" v-if="usuario.llenarold=='0'" class="btn btn-success btn-sm" v-on:click.prevent="altaUsuarioOld(usuario)" data-placement="top" data-toggle="tooltip" title="Autorizar Usuario Completar Asistencias Pasadas"><i class="fa fa-calendar-check-o"></i></a>
  ...
  <div class="modal-dialog modal-lg" role="document"  id="modaltamanio1">
    <div class="modal-content">
      ...
      <div class="box" id="o" style="border:0px; box-shadow:none;" >
            ...
            <!-- form start -->
            <div id="FichaUsuario"> 
       <?php echo $__env->make('usuarios.ficha', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
...
<?php /**PATH D:\Proyectos\ugel carhuaz\ugelsistemaasistencia\resources\views/usuarios/usuario.blade.php ENDPATH**/ ?>