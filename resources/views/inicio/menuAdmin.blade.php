...
<div class="col-lg-12 col-xs-12">
		...
		<div class="col-lg-3 col-xs-6" >
          <div class="small-box bg-green">
            ...
            <a href="{{URL::to('asistAlumnos')}}" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            ...
            <a href="{{ URL::to('asistPersonal')}}" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
